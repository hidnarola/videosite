    ...
    public function user(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if($user_data){
                 ...
                 $this->session->set_flashdata('success', 'You already have an account under the entered Email address.');
                 redirect('login');   
            }else{
                $data['email_id'] = $this->input->post('email_id');      
                $data['zipcode'] = $this->input->post('zipcode');      
                $data['country_list'] = 231;      
     ...
     public function user_2(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if($data['email_id'] == '') // IF direct access 2nd step then goto first step 
            {
