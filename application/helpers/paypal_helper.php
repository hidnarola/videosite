<?php
	...
	********************************************/
	...
	// ToothFairy Credentials	
	// define('API_UserName', 'payments_api1.yourtoothfairy.com');
	// define('API_Password', 'YMF7F5JKVK4ZXU3F');
	// define('API_Signature', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AGXSDylym721QIKwvp.m0jpTNkZ5');	
	...
	*/
	...
	// v! Do not make any changes into this function
	//----------------Cancel Billing Agreement - BillAgreementUpdate @DHK -----------
	function cancel_billing_agreement($REFERENCEID='B-7B6764950D0480641'){
		$nvpstr ="&VERSION=86";
		$nvpstr .="&REFERENCEID=".$REFERENCEID;
		$nvpstr .="&BILLINGAGREEMENTSTATUS=Canceled";		
		$resArray=hash_call("BillAgreementUpdate",$nvpstr);
