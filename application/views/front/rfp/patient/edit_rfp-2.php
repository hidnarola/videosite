								...
								<?php foreach($teeth_arr as $key=>$val) :?>
									<div class="treatment_cat_<?=$key?>">	
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
													<label><span class="cat_label">Treatment Category For Teeth <?=$key?> <span class="required_field">*</span></span>
								...
								?>
									...
									<div class="treatment_cat_<?=$val?>">
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
													<label><span class="cat_label">Treatment Category For Teeth <?=$val?> <span class="required_field">*</span></span>
													<span class="check_label">	
...
<script type="text/javascript">
	...
	$(".toggle_cat").click(function(e){
		...
		if($(this). prop("checked") == true) {
			...
			str = str.replace('<span class="cat_label"></span>','<span class="cat_label"> Treatment Category For Teeth '+teeth_val+' <span class="required_field">*</span></span>');
