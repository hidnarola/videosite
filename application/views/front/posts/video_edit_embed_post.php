<div class="form-element">    
    ...
    <form method="post" action="" id="frmblog" enctype="multipart/form-data">
        ...
        <div class="input-wrap full-width">
            ...
            <?php if($_POST){$post_embed_video = set_value('embed_video'); }else{$post_embed_video = $post_data['video']['embed_link']; } ?>
            <input type="text" name="embed_video" id ="embed_video" placeholder="Video Url" value="<?php echo htmlspecialchars($post_embed_video); ?>" class="form-css" />
        </div>
