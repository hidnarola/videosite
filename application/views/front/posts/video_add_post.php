    ...
    <div class="form-element">
        ...
        <form method="post" action="" id="frmblog" enctype="multipart/form-data">
            <div class="input-wrap">
                ...
                <select class="form-control selectpicker_blog" data-placeholder="Select a Channel"  name="channel" id="channel" class="form-css">
            ...
            <div class="input-wrap">
                ...
                <select class="form-control category selectpicker_blog" data-placeholder="Select a Category"  name="category" id="category"class="form-css">
            ...
            <div class="input-wrap">
                ...
                <select class="form-control sub_category selectpicker_blog" data-placeholder="Select a Sub Category"  name="sub_category" id="sub_category" class="form-css">
