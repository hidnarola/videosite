				...
				<div class="tab-pane fade <?php if($tab == 'info'){ echo 'in active'; }?>" id="info">
					...
					<form role="form"  method="post">
						...
						<div class="form-group">
							...
							<input type="text" placeholder="MM-DD-YYYY" name="birth_date" data-format="mm-dd-yyyy" class="form-control birth_date" 
								   value="<?php echo ($db_data['birth_date']) ? date("m-d-Y",strtotime($db_data['birth_date'])):'' ; ?>">
							...
							<div class="row">
								<div class="col-md-9 col-sm-8">
									...
									<div class="clearfix margin-top-20">
										...
										<p>
											Please choose .jpg, .jpeg and .png  file type with max. 2 MB size. 
										</p>
									</div>
