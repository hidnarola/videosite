		...
		<div class="row">			
			...
			<div class="col-md-12">
				...
				<form method="post" action="<?=base_url('registration/user_2')?>" id="frmregister" >					
					<input type="hidden" name="email_id" value="<?php echo isset($email_id)?$email_id:''; ?>">
					<input type="hidden" name="zipcode" value="<?php echo isset($zipcode)?$zipcode:''; ?>">
					<input type="hidden" name="state_id" value="<?php echo isset($state_id)?$state_id:''; ?>">
					<input type="hidden" name="role" value="<?php echo isset($role_id)?$role_id:''; ?>">
