<div class="white-box">
    <h3 class="h3-title"> Recommended Posts</h3>
    <div class="user-srh">
        <form>
    ...
    <div class="home-listing">
        <ul class="ul-list">
        <?php if (!empty($recommend)) { foreach ($recommend as $rec) {?>
            <li>
                <div class="list-box">
                    <div class="list-top">
                    <?php if($rec['post_type'] == 'blog'){?>
                        <a class="img-anchor" href="<?php echo base_url() . 'blog/' . $rec['slug']; ?>"><img src="<?php echo base_url() . $rec['main_image'] ?>" alt="" onerror="this.src='<?php echo base_url().'public/front/images/imgnotfound.jpg'; ?>'"/></a>
                        <a href="" class="tag-a">A</a>
                        <?php } else if($rec['post_type'] == 'gallery'){?>
                        <a class="img-anchor" href="<?php echo base_url() . 'gallery/' . $rec['slug']; ?>"><img src="<?php echo base_url() . $rec['main_image'] ?>" alt="" onerror="this.src='<?php echo base_url().'public/front/images/imgnotfound.jpg'; ?>'"/></a>
                        <a href="" class="tag-g">G</a>
                        <?php } else if($rec['post_type'] == 'video'){?>
                        <a class="img-anchor" href="<?php echo base_url() . 'video/' . $rec['slug']; ?>"><img src="<?php echo base_url() . $rec['main_image'] ?>" alt="" onerror="this.src='<?php echo base_url().'public/front/images/imgnotfound.jpg'; ?>'"/></a>
