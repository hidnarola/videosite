            ...
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <link href="https://fonts.googleapis.com/css?family=Comfortaa:300,400,700|Roboto:400,500" rel="stylesheet">
                    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" >
                        <link href="<?php echo DEFAULT_ADMIN_CSS_PATH ?>bootstrap.min.css" rel="stylesheet">
                            <link href="<?php echo DEFAULT_ADMIN_CSS_PATH ?>font.css" rel="stylesheet">
                                <link href="<?php echo DEFAULT_ADMIN_CSS_PATH ?>style.css" rel="stylesheet" />
                                <link href="<?php echo DEFAULT_ADMIN_CSS_PATH ?>responsive.css" rel="stylesheet" />
                                ...
                                <header class="header">
                                    ...
                                    <div class="header-upload"><a href="">submit video <span><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                    ...
                                                    <g>
                                                        <g>
                                                            ...
                                                            <path d="M244.7,267.95c6.8,0,12.3-5.5,12.3-12.3V45.85l59.3,59.3c2.4,2.4,5.5,3.6,8.7,3.6s6.3-1.2,8.7-3.6
                                                                  c4.8-4.8,4.8-12.5,0-17.3l-80.3-80.2c-4.8-4.8-12.5-4.8-17.3,0l-80.2,80.2c-4.8,4.8-4.8,12.5,0,17.3s12.5,4.8,17.3,0l59.3-59.3
                                                                  v209.8C232.5,262.45,237.9,267.95,244.7,267.95z"/>
                                                        </g>
                                                    </g>
                                                    <g>
                                                    </g>
