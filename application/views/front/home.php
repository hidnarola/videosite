		...
		<ul class="hide">
			...
			<li data-transition="parallaxtobottom" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off"  data-title="Architectural View">
				...
				<div class="tp-caption sfb tp-resizeme"
					...
					style="z-index: 4; max-width: auto;">
						<a class="btn btn-primary btn-lg btn-our-service" href="<?php echo base_url().'what-we-can-do-for-you'; ?>">OUR SERVICES &nbsp; <i class="fa fa-angle-right"></i></a>
						<!-- <a class="btn btn-primary btn-lg" href="<?php echo base_url().'registration/user'; ?>">JOIN NOW &nbsp; <i class="fa fa-angle-right"></i></a> -->
				</div>
			...
			<li data-transition="parallaxtotop" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" data-title="Bright Future">
				...
				<div class="tp-caption skewfromrightshort tp-resizeme"
					...
					data-endspeed="500"
					style="z-index: 3; font-size:20px; color:#fff; font-weight:300; text-shadow:none;">
						Join us for free and offer your professional services to Patients in your area!
				</div>
				...
				<div class="tp-caption sfb tp-resizeme"
					...
					data-endspeed="500"
					style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">
						<a class="btn btn-default btn-lg " href="<?php echo base_url().'dashboard'; ?>"> OFFER YOUR SERVICE &nbsp; 
							<i class="fa fa-angle-right"></i>
						</a>
				</div>
			</li>
...
<script>
$(document).on('click','.btn-our-service', function(event) {
    event.preventDefault();
    $('html, body').animate({
        scrollTop: $("#find-dental").offset().top-70
    }, 2000);
});
</script>
