...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal form-validate" id="frmadmin" method="POST" enctype="multipart/form-data" onsubmit="return zip_validate()">
                <div class="panel panel-flat">
                    <div class="panel-body">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <textarea rows="4" name="address" class="form-control" placeholder="Your Address"><?php echo $user_data['address']; ?></textarea>
                            </div>
                        </div> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">   
                                <input type="text" name="street" class="form-control" value="<?php echo $user_data['street']; ?>" placeholder="Street name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="city" class="form-control" placeholder="City" value="<?php echo $user_data['city']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="zipcode" id="zipcode" class="form-control" onblur="check_zipcode()" 
                                      placeholder="Zip code" value="<?php echo $user_data['zipcode']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="phone" minlength="6" class="form-control" placeholder="Phone" value="<?php echo $user_data['phone']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="hidden" name="H_avatar" value="<?php echo $user_data['avatar']; ?>">
                            </div>
                            <div class="col-lg-3">
                                <img id="img-preview" src="<?php if($user_data['avatar'] != '') {
                        ...
                        <div class="text-right">                            
                            <input type="hidden" name="longitude" id="longitude" value="<?php echo $user_data['longitude']; ?>">
                            <input type="hidden" name="latitude" id="latitude" value="<?php echo $user_data['latitude']; ?>">
...
<script type="text/javascript">
        ...
        rules: {
            ...
            email_id:{
                ...
                remote:{
                    ...
                    type:"POST",
                    data:{email_id:function () {return $("#email_id").val();},old_email_id:function(){ return '<?php echo $user_data["email_id"]; ?>'; }}
                }
            },            
    ...
    $("#country_id").val("<?php echo $user_data['country_id']; ?>");
     $("#state_id").val("<?php echo $user_data['state_id']; ?>");   
