...
//        var id = '<?php // echo $blog['user_id']        ?>';
        $('.datatable-basic').dataTable({
            ...
            order: [[0, "asc"]],
            ordering: false,
            ajax: '<?php echo base_url(); ?>admin/userpost/list_blog',
            columns: [
                {
                    data: "id",
                    visible: true,
...
//                        console.log(id);
                        if (full.is_blocked == '0') {
                            ...
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/userpost/activate_blog/' + full.id + '" class="btn border-success text-success-600 btn-flat btn-icon btn-rounded"  title="Unblock"><i class="icon-checkmark-circle"></i></a>';
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/userpost/delete_blog/' + full.id + '" class="btn border-danger btn_delete text-danger-600 btn-flat btn-icon btn-rounded" title="Delete"><i class="icon-cross2"></i></a>';
                        }
                        return action;
                    }
