                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full.is_blocked == '0') {
                            action += '<a href="<?php echo base_url(); ?>admin/users/see_gallery/' + id + '" class="btn border-primary text-primary-600 btn-flat btn-icon btn-rounded btn-sm" title="View"><i class="icon-eye4"></i></a>';
