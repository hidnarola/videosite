                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if(data == 0){
                            ...
                            status = '<span class="label label-success">Standard Request</span>';
                        }else if(data == 2){
                            status = '<span class="label label-warning">Quick request eligible</span>';
                        }else if(data == 3){
                            status = '<span class="label label-primary">Auto bid</span>';
                        }
                        return status;
                    }
                },
