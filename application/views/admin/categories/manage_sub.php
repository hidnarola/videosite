                        ...
                        <div class="form-group">
                            <div class="search-overlay-menu">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="search" autocomplete="off" class="form-control" name="field-keywords" placeholder="Type your search terms..." id="twotabsearchtextbox1" value="<?php echo (isset($deals['business_name'])) ? $deals['business_name'] : set_value('business_name'); ?>"></div>
                                <!--</form>-->
                            </div>
                        </div>
...
//                window.location = ROOT_PATH + 'locations/' + item.value;
            }
        });
    });
