    ...
    <div class="panel panel-flat">
        ...
        <table class="table datatable-basic">
            ...
            <?php foreach ($channels as $key => $channel) {?>
                <tr>
                   <td><?php echo $channel['channel_name'] ; ?> </td><td>All Posts (<?php echo $channel['posts']; ?>)</td><td> Videos (<?php echo $channel['videos']; ?>)</td> <td>Blogs (<?php echo $channel['blogs']; ?>)</td><td> Galleries (<?php echo $channel['gallery']; ?>) </td> <td> Subscribers (<?php echo $channel['subscribers']; ?>) </td> <td> Likes (<?php echo $channel['likes']; ?>) </td> <td> Views (<?php echo $channel['views']; ?>) </td>
                </tr>
            <?php } ?>
            </thead>
        </table>
