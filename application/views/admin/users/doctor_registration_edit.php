...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Admin</span> - Doctor</h4>
        </div>
    </div>
...
<div class="content">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal form-validate" id="frmdoctor" method="POST">
                <div class="panel panel-flat">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">First Name:</label>
                            <div class="col-lg-3">
                                <input type="text" name="fname" class="form-control" placeholder="First Name" value="<?php echo $doctor_data['fname']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="lname" class="form-control" placeholder="Last Name" value="<?php echo $doctor_data['lname']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="zipcode" id="zipcode" class="form-control" onblur="check_zipcode()" 
                                      placeholder="Zip code" value="<?php echo $doctor_data['zipcode']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="phone" minlength="6" class="form-control" placeholder="Phone" value="<?php echo $doctor_data['phone']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="birth_date" class="form-control" id="anytime-date" placeholder="Birth Date" 
                                       value="<?php echo $doctor_data['birth_date']; ?>">
                            </div>
                        </div>

                        <div class="text-right">                            
                            <input type="hidden" name="longitude" id="longitude" value="<?php echo $doctor_data['longitude']; ?>">
                            <input type="hidden" name="latitude" id="latitude" value="<?php echo $doctor_data['latitude']; ?>">
