<head>
    ...
    <link href="<?php echo DEFAULT_ADMIN_CSS_PATH . 'select2.min.css' ?>" rel="stylesheet" />
    <script src="<?php echo DEFAULT_ADMIN_JS_PATH . 'select2.min.js' ?>"></script>
    <script src="<?php echo DEFAULT_ADMIN_JS_PATH . "bootstrap-typeahead.js"; ?>"></script>
    <!-- /theme JS files -->
